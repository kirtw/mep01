ppPARinit ;CKW/ESC i26mar24 umep./ rppar1/ ;2024-0326-30;Init SR for Parser
;
;
;
top   D IKILL
...
;*
Istb 
    D stb^dv3("InitGRAB","StkP:4/,grab:10,grde:20,#")
    D stb^dv3("grabPASS","QB:10/,grab:10,gran:10,Rn:4,grulst:25,tok:8,toty:2,gropsr:10")
    D stb^dv3("grabFAIL","QB:10/,grab:10,QB:10,QG:10,QT:10")
    D stb^dv3("InitGRAN","StkP:4/,gran:10,Rn:4,grulst:25")
    D stb^dv3("granPASS","QN:10,gran:10,Rn:4,grulst:25,tok:8,toty:2,gropsr:10")
    ...
    D stb^dv3("termPASS","gnn:10,gran:10,Rn:4,grulst:25,tok:8,toty:2,gropsr:10")
